...
/* Hazal Mestci, Final Draft for Code 1 ----------------------------------
 * date: 12/20/2016
 * Works only with Processing 2
 * Example code by Max Rheiner / Interaction Design / Zhdk / http://iad.zhdk.ch/
 * Special thanks to Bryan Ma
...
void draw()
{
  ...
  canvas.rotateY(radians(frameCount * 0.1));
  canvas.rotateX(PI);
  canvas.scale(0.3);
...
void drawLimb(int userId, int jointType1, int jointType2)
{
  ...
  canvas.stroke(0);
  canvas.line(a_3d.x, a_3d.y, a_3d.z, b_3d.x, b_3d.y, b_3d.z);
